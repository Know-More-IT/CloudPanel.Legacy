<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="enable.aspx.cs" Inherits="CloudPanel.company.lync.enable" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContainer" runat="server">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <a href="#" title="Exchange" class="tip-bottom"><i class="icon-comment"></i><%= Resources.LocalizedText.Global_Lync %></a>
                <a href="#" title="Exchange" class="tip-bottom"><i class="icon-envelope"></i><%= Resources.LocalizedText.Global_Modify %></a>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div id="enableLync" class="row-fluid" runat="server">
                <div class="span12">
                <div class="widget-box">
                  <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
                    <h5><%= Resources.LocalizedText.Lync_EnableTitle %></h5>
                  </div>
                  <div class="widget-content ">
                    <div style="text-align: center">
                        <%= Resources.LocalizedText.Lync_EnableDescription %>
                    </div>
                    ...
                    <div style="text-align: center">
                        <asp:Button ID="btnEnableLync" runat="server" Text="<%$ Resources:LocalizedText, Button_Enable %>" CssClass="btn btn-success" OnClick="btnEnableLync_Click" />
                    </div>
            ...
            <div id="disableLync" class="row-fluid" runat="server" visible="false">
                <div class="span12">
                <div class="widget-box">
                  <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
                  ...
                  <div class="widget-content ">
                    ...
                    <div style="text-align: center">
                        <asp:Button ID="btnDisableLync" runat="server" Text="<%$ Resources:LocalizedText, Button_Disable %>" CssClass="btn btn-danger" OnClick="btnDisableLync_Click" />
                    </div>
