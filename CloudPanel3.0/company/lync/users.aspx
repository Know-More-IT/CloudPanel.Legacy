<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="CloudPanel.company.lync.users" %>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb">
                ...
                <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="#"><i class="icon-user"></i>Lync Users</asp:HyperLink>
            </div>
                        ...
                        <div class="widget-content nopadding">
                            <div class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ID="txtPassword1" runat="server" name="passwords" TextMode="Password" TabIndex="27" AutoComplete="Off"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">* <%= Resources.LocalizedText.PwdEnterAgain %></label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtPassword2" runat="server" name="passwords" TextMode="Password" TabIndex="28" AutoComplete="Off"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
